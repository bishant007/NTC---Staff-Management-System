...
import {
  LayoutDashboard, Users, FileText, LogOut, Key, BarChart3,
  Clock, UserCog, PlusCircle, ClipboardList, User, History, Bell
} from 'lucide-react';
    ...
    switch (role) {
      ...
      case 'section_head':
        return [
          ...
          { label: 'Pending', icon: <Clock size={20} />, path: '/section-head/pending' },
          { label: 'History', icon: <History size={20} />, path: '/section-head/history' },
      ...
      case 'office_incharge':
        return [
          { label: 'Dashboard', icon: <LayoutDashboard size={20} />, path: '/office-incharge/dashboard' },
          { label: 'Pending', icon: <Clock size={20} />, path: '/office-incharge/pending' },
          { label: 'History', icon: <History size={20} />, path: '/office-incharge/history' },
          { label: 'Section Heads', icon: <UserCog size={20} />, path: '/office-incharge/section-heads' },
          { label: 'My Leave', icon: <FileText size={20} />, path: '/staff/new-request' },
          { label: 'My Profile', icon: <User size={20} />, path: '/profile' },
        ];
      case 'staff':
