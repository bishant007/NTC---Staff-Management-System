    ...
    <AuthProvider>
      <BrowserRouter>
        <Routes>
          ...
          {/* Shared across staff-level roles */}
          <Route path="/profile" element={
            <ProtectedRoute allowedRoles={ALL_STAFF_ROLES}><ProfilePage /></ProtectedRoute>
          } />

          {/* Staff-specific pages (also usable by SH/DH for their own leave) */}
          ...
          <Route path="/department-head/dashboard" element={
            <ProtectedRoute allowedRoles={["department_head"]}><DeptHeadDashboard /></ProtectedRoute>
          } />
          <Route path="/department-head/pending" element={
            <ProtectedRoute allowedRoles={["department_head"]}><DeptHeadPending /></ProtectedRoute>
          } />
          <Route path="/department-head/history" element={
            <ProtectedRoute allowedRoles={["department_head"]}><DeptHeadHistory /></ProtectedRoute>
          } />
          <Route path="/department-head/section-heads" element={
            <ProtectedRoute allowedRoles={["department_head"]}><SectionHeads /></ProtectedRoute>
          } />
        </Routes>
      </BrowserRouter>
    </AuthProvider>
